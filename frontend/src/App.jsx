...
//         const data = await response.json();
//         setUser(data.user);
//         setIsAdmin(data.user.is_admin);  // ADD THIS
//         setIsAuthenticated(true);
//       } else {
//         localStorage.removeItem('token');
//       }
...
// Everything else is delegated to Scanner / Analysis / TradeCycles / AdminPanel.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <div className="app">
      ...
      <header className="header">
        <div className="header-content">
          ...
          <nav className="nav">
            <NavBtn active={activeTab === 'scanner'} onClick={() => setActiveTab('scanner')}>
              <Search size={18} /> Scanner
            </NavBtn>
            <NavBtn active={activeTab === 'analysis'} onClick={() => setActiveTab('analysis')}>
              <BarChart3 size={18} /> Analysis
            </NavBtn>
            <NavBtn active={activeTab === 'cycles'} onClick={() => setActiveTab('cycles')}>
              <History size={18} /> Trade Cycles
            </NavBtn>
          </nav>
